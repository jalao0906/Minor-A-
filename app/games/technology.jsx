...
const allQuestions = [
    { 
        ...
        answer: "CPU",
        image: require('../../assets/technology/question1.jpg') 
    },
    { 
        question: "What does GPU stand for?", 
        options: ["General Processing Unit", "Graphics Processing Unit", "Graphical Power Utility", "Gaming Processing Unit"],
        answer: "Graphics Processing Unit",
        image: require('../../assets/technology/question2.jpeg') 
    },
    { 
        question: "Which component provides temporary storage for running applications?", 
        options: ["ROM", "RAM", "Hard Drive", "PSU"],
        answer: "RAM",
        image: require('../../assets/technology/question3.jpeg') 
    },
    { 
        question: "Which of the following is an example of an output device?", 
        options: ["Scanner", "Mouse", "Microphone", "Printer"],
        answer: "Printer",
        image: require('../../assets/technology/question4.jpg') 
    },
    { 
        question: "Which storage device is the fastest?", 
        options: ["HDD", "SSD ", "DVD", "Flash Drive"],
        answer: "SSD ",
        image: require('../../assets/technology/question5.png') 
    },
    { 
        question: "What is the purpose of an IP address?", 
        options: ["To store user data", "To identify a device on a network", "To increase processing speed", "To act as a firewall"],
        answer: "To identify a device on a network",
        image: require('../../assets/technology/question6.jpg') 
    },
    { 
        question: "Which of the following is a private IP address?", 
        options: ["192.168.1.1", "8.8.8.8", "172.217.160.238", "54.32.108.99"],
        answer: "192.168.1.1",
        image: require('../../assets/technology/question7.png') 
    },
    { 
        question: "What is phishing?", 
        options: ["Sending fake emails to steal information", "Hacking passwords", "Scanning for malware", "Installing security software"],
        answer: "Sending fake emails to steal information",
        image: require('../../assets/technology/question8.jpg') 
    },
    { 
        question: "Which of the following is an example of system software?", 
        options: ["Microsoft Word", "Google Chrome", " Windows 10", "Adobe Photoshop"],
        answer: " Windows 10",
        image: require('../../assets/technology/question9.jpeg') 
    },
    { 
        question: "What should you do first when a computer crashes?", 
        options: ["Call tech support", "Buy a new computer", "Unplug the keyboard", "Restart the computer"],
        answer: "Restart the computer",
        image: require('../../assets/technology/question10.jpg') 
    }
];
